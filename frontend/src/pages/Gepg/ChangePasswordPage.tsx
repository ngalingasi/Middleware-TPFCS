  ...
  return (
    <div>
      ...
      <div className="relative">
        ...
        />
        <span onClick={onToggle} className="absolute z-30 -translate-y-1/2 cursor-pointer right-4 top-1/2">
          {show ? (
...
export default function ChangePasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await gepgAuthApi.changePassword(currentPassword, newPassword);
      navigate('/');
    } catch (err: any) {
      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm p-8">
          <div className="text-center mb-8">
            <img
              src="/logo.png"
              alt="Tanzania Police Force Corporation Sole"
